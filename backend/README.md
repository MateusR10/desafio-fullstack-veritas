...
### 1. Iniciar o Backend
No terminal, entre na pasta do backend com o comando:
cd backend
Após entrar, execute com o comando:
go run main.go

Aqui o servidor estará rodando em http://localhost:8080

### 2. Iniciar o Frontend
Após executar os comandos do Backend, abra uma nova Aba no Terminal e entre na pasta do Frontend com o comando:
cd frontend
Em seguida, digite o comando:
npm run dev

Após o comando, vai aparecer o link aonde irá rodar a aplicação:
http://localhost:5173